...
- (NSString *)googleURLString {
    ...
    NSMutableString *url=[NSMutableString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/autocomplete/json?input=%@&types=geocode&language=fr&key=%@",[input stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],key];
