...
//        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor colorWithRed:0.0f green:0.831f blue:0.176f alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // green
        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor colorWithRed: 251.0/255.0 green: 11.0/255.0 blue: 80.0/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // green
        
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed: 75.0/255.0 green: 203.0/255.0 blue: 242.0/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // blue
