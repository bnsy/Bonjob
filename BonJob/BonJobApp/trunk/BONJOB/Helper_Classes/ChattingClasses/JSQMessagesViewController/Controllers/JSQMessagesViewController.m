...
- (void)jsq_configureMessagesViewController
{
    ...
    self.toolbarHeightConstraint.constant = self.inputToolbar.preferredDefaultHeight;
        ...
        //Static Maximum keyboard Heigth
        
        self.inputToolbar.maximumHeight=88;
...
- (void)scrollToBottomAnimated:(BOOL)animated
{
    ...
    NSInteger items = [self.collectionView numberOfItemsInSection:1];
    ...
    NSUInteger finalRow = MAX(0, [self.collectionView numberOfItemsInSection:1] - 1);
    NSIndexPath *finalIndexPath = [NSIndexPath indexPathForItem:finalRow inSection:1];
