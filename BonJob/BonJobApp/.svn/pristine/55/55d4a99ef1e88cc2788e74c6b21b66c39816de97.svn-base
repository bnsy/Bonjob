...
@synthesize name, reference, identifier, type,placeId;
...
- (NSString *)description {
    return [NSString stringWithFormat:@"Name: %@, Reference: %@, Identifier: %@, Type: %@, PlaceId: %@",
            name, reference, identifier, SPPlaceTypeStringForPlaceType(type),placeId];
}
