...
{
    APPDELEGATE.arrSelContractSeeker.removeAllObjects;
    APPDELEGATE.arrSelExperienceSeeker.removeAllObjects;
    APPDELEGATE.arrSelHoursSeeker.removeAllObjects;
    APPDELEGATE.arrSelEducationSeeker.removeAllObjects;
}
    ...
    if ([methodNameIs isEqualToString:@"getJob"])
    {
        if ([[responseDict valueForKey:@"success"] boolValue]==1)
        {
            ...
            if ([[[responseDict valueForKey:@"data"] valueForKey:@"allJobs"] count]>0)
            {
                ...
                APPDELEGATE.arrSelExperienceSeeker = arrSelExperience;
                APPDELEGATE.arrSelContractSeeker = arrSelContract;
                APPDELEGATE.arrSelEducationSeeker = arrSelEducation;
                APPDELEGATE.arrSelHoursSeeker = arrSelHours;
                ...
                APPDELEGATE.isFilterSeeker = YES;
                [self.navigationController popViewControllerAnimated:YES];
            }
            else
            {
